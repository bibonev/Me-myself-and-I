...
var hobbies = [
    {
        ...
        text: 'I have always wanted to become well-built. I have trained different sports since' +
                ...
                'hat is what keeps me motivated and passionated about it - gym exercises. I ha' +
                've been training for couple of months now and I changed two different training p' +
                'rogrammes so I can imporve my body more. I am going to the gym afer I f' +
                'inish work, four times per week and after every training I feel much relieved and that brings me huge ammount of happiness.',
        image: 'gym.jpg',
        page: 5
    }, {
        name: 'Cooking',
        ...
        text: 'All I want in the end of the day is just to have a chat with my parents and my b' +
                ...
                ' glass of wine with your best friends in the end of the week',
        image: 'family-friends.jpg',
        page: 3
    }, {
        name: 'Hackathons',
        text: 'After  my family and my friends, there is one more thing that' +
                ...
                ' are the best place to do that. Moreover, you can come up with so many amazing ideas ' +
                '. I have attended many hack' +
                'athonts so far - couple of BrumHacks, HackNotts, Facebook Hacakthon and others.',
        ...
        text: 'That has been a recent hobby of mine. I started listening to audio books, using ' +
                ...
                'ing so much information, out of a book, is much less than I had ever imagined.  ' +
